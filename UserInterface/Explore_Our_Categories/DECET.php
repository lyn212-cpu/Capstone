<?php
    ...
    $sql = "SELECT course_id, course_name, training_center_name, department, duration, slots_available, blockLot, street, subdivision, barangay, city, province, zipCode, contact_info, course_description, requirements 
            FROM nc_course 
            WHERE department LIKE '%Diploma in Electronics Engineering Technology%' AND status = 'approved'";
...
<head>
    ...
    <title>Diploma in Electronics Engineering Technology Courses</title>
    <style>
        .course-card {
            border-radius: 12px;
