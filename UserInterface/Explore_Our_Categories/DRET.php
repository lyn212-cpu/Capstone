<?php
    ...
    // Fetch all courses under the department "Diploma in Railway Engineering Technology"
    $sql = "SELECT course_id, course_name, training_center_name, department, duration, slots_available, blockLot, street, subdivision, barangay, city, province, zipCode, contact_info, course_description, requirements 
            FROM nc_course 
            WHERE department LIKE '%Diploma in Railway Engineering Technology%' AND status = 'approved'";
...
<head>
    ...
    <title>Diploma in Railway Engineering Technology Courses</title>
    <style>
        .course-card {
            border-radius: 12px;
    ...
    <div class="container py-4">
        ...
        <div class="text-center mb-4">
            <div class="d-flex justify-content-center align-items-center mb-2">
                <i class="fas fa-train-subway fa-2x text-primary me-2"></i>
                <h2 class="fw-bold mb-0">Diploma in Railway Engineering Technology Courses</h2>
            </div>
