...
// Fetch all courses under the department "Diploma in Computer Engineering Technology"
$sql = "SELECT course_id, course_name, training_center_name, department, duration, slots_available, blockLot, street, subdivision, barangay, city, province, zipCode, contact_info, course_description, requirements 
            FROM nc_course 
            WHERE department LIKE '%Diploma in Computer Engineering Technology%' AND status = 'approved'";
...
<head>
    ...
    <title>Diploma in Computer Engineering Technology Courses</title>
    <style>
        .course-card {
            border-radius: 12px;
    ...
    <div class="container py-4">
        ...
        <div class="text-center mb-4">
            <div class="d-flex justify-content-center align-items-center mb-2">
                ...
                <h2 class="fw-bold mb-0">Diploma in Computer Engineering Technology Courses</h2>
            </div>
                        ...
                        <div class="card course-card shadow-sm h-100">
                            <div class="card-body">
                                ...
                                <div class="course-meta mb-1">
                                    ...
                                    <?php
                                    // Combine the fields for location and details
                                    $location = [
                                        $row['blockLot'],
                                        $row['street'],
                                        $row['subdivision'],
