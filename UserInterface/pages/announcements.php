<p?php session_start(); include '../../Backend/connect.php' ; if (!isset($_SESSION['user_id'])) { header("Location:
    ../Sign_in.php"); exit(); } ?>
    <!doctype html>
    <html lang="en">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNav">
                            ...
                            <div class="d-flex align-items-center justify-content-end p-2">
                                <div class="dropdown">
                                    <a class="btn btn-light d-flex align-items-center rounded-circle p-0 border-0"
                                        href="#" role="button" id="userMenu" data-bs-toggle="dropdown"
                                        aria-expanded="false" style="width: 44px; height: 44px;">
                    ...
                    <div class="col-12 col-md-10 d-flex flex-column flex-md-row justify-content-between gap-4">
                        ...
                        <div class="bg-white p-4 rounded shadow-sm border flex-fill"
                            ...
                            <ul class="list-unstyled mb-0">
                                <li class="mb-3"><strong>MANUEL M. MUHI, D.TECH</strong><br><small
                                        class="text-muted">ASEAN
                                ...
                                <li class="mb-3"><strong>PASCUALITO B. GATAN, MBA</strong><br><small
                                        class="text-muted">VICE
