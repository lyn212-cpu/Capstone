    ...
    <div class="course-box text-white shadow-lg rounded-4 p-4 p-md-5">
        <div class="row g-4 align-items-center">
            ...
            <div class="col-md-6">
                ...
                <p><strong>Location:</strong> #300 Doa Emilia Bldg., 10th Ave. cor. Rizal Ave. Ext., Caloocan City Metro Manila</p>
            ...
            <!-- Right Column -->
            <div class="col-md-6">
                <img src="../SMAW.jpg" alt="Course Image" class="img-fluid course-image shadow">
            </div>
        </div>
    </div>
</div>
