    ...
    <div class="container py-5">
        ...
        <div class="course-box text-white shadow-lg rounded-4 p-4 p-md-5">
            <div class="row g-4 align-items-center">
                <!-- Left Column -->
                <div class="col-md-6">
                    <h1 class="h4 fw-bold text-white">Shielded Metal Arc Welding NC II</h1>
                    <p class="fw-semibold mb-1">Asian College of Science and Technology Foundation, Inc.</p>
                    <p><strong>Duration:</strong> 5 months</p>
                    <p><strong>Slots Available:</strong> 16</p>
                    <p><strong>Location:</strong> #300 Doa Emilia Bldg., 10th Ave. cor. Rizal Ave. Ext., Caloocan City
                        Metro Manila</p>
                    <p><strong>Contact:</strong> 0962 375 6251 | ACST@example.com</p>

                    <h5 class="mt-4 fw-bold">Course Description:</h5>
                    <p>
                        This course provides essential training in welding techniques,
                        safety practices, and blueprint reading. Students will learn
                        how to perform shielded metal arc welding (SMAW) on various
                ...
                <!-- Right Column -->
                <div class="col-md-6">
                    <img src="../../Assets/COURSE_BG/smaw.jpg" alt="Course Image" class="img-fluid course-image shadow">
                </div>
            </div>
        </div>
    </div>
