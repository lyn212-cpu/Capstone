        ...
        <div class="card shadow-sm rounded-4 border-0">
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <button class="btn btn-info text-white fw-semibold px-4">Save Changes</button>
                </div>
                ...
                <form>
                    <div class="row g-3">
                        <div class="col-md-3 col-sm-6">
                            ...
                            <input type="text" class="form-control" value="Lorem">
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <label class="form-label fw-semibold">Last name:</label>
                            <input type="text" class="form-control" value="Dolor">
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <label class="form-label fw-semibold">Middle name:</label>
                            <input type="text" class="form-control" value="Ipsum">
                        </div>
                        <div class="col-md-3 col-sm-6">
                        ...
                        <div class="col-md-3 col-sm-6">
                            ...
                            <input type="date" class="form-control" value="2025-01-02">
                        </div>
                        <div class="col-md-9 col-sm-6">
                            <label class="form-label fw-semibold">Section:</label>
                            <input type="text" class="form-control" value="Diploma in Information Technology">
                        </div>
                    </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" value="123 Tutuban St. Tondo Manila">
                        </div>
                    </div>
                </form>
            </div>
