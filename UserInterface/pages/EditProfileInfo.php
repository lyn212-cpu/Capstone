...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $new_course = trim($_POST['section'] ?? '');

    if (!empty($new_full_name) && !empty($new_course)) {
        $update_stmt = $conn->prepare("UPDATE users SET full_name = ?, course = ? WHERE user_id = ?");
        $update_stmt->bind_param("ssi", $new_full_name, $new_course, $id);
        if ($update_stmt->execute()) {
            // Refresh the data so updated values reflect on the form
            $stmt = $conn->prepare("SELECT * FROM users WHERE user_id = ?");
            $stmt->bind_param("i", $id);
            $stmt->execute();
            $result = $stmt->get_result();
                ...
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <div class="d-flex gap-2">
                            <a href="userProfile.php" class="btn btn-secondary fw-semibold px-4">Back</a>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-9 col-sm-12">
                                ...
                                <select class="form-select" name="section" size="1" style="min-width:450px;">
                                    ...
                                    <option value="Diploma in Information Technology" <?php if ($user && $user['course'] == "Diploma in Information Technology") echo "selected"; ?>>Diploma in Information Technology</option>
                                    <option value="Diploma in Computer Engineering Technology" <?php if ($user && $user['course'] == "Diploma in Computer Engineering Technology") echo "selected"; ?>>Diploma in Computer Engineering Technology</option>
                                    <option value="Diploma in Office Management Technology" <?php if ($user && $user['course'] == "Diploma in Office Management Technology") echo "selected"; ?>>Diploma in Office Management Technology</option>
                                    <option value="Diploma in Electronics Engineering Technology" <?php if ($user && $user['course'] == "Diploma in Electronics Engineering Technology") echo "selected"; ?>>Diploma in Electronics Engineering Technology</option>
                                    <option value="Diploma in Electrical Technology" <?php if ($user && $user['course'] == "Diploma in Electrical Technology") echo "selected"; ?>>Diploma in Electrical Technology</option>
                                    <option value="Diploma in Mechanical Engineering Technology" <?php if ($user && $user['course'] == "Diploma in Mechanical Engineering Technology") echo "selected"; ?>>Diploma in Mechanical Engineering Technology</option>
                                    <option value="Diploma in Civil Engineering Technology" <?php if ($user && $user['course'] == "Diploma in Civil Engineering Technology") echo "selected"; ?>>Diploma in Civil Engineering Technology</option>
                                    <option value="Diploma in Railway Engineering Technology" <?php if ($user && $user['course'] == "Diploma in Railway Engineering Technology") echo "selected"; ?>>Diploma in Railway Engineering Technology</option>
                                </select>
