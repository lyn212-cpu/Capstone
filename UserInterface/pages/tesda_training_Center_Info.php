...
<div class="container py-5">
    <div class="card shadow-sm p-4 mx-auto" style="max-width: 1140px;">
        <div class="d-flex justify-content-between align-items-start mb-4 flex-wrap">
            ...
            <!-- Back Button -->
            <a href="../Explore_Our_Categories/DCET.php" class="btn btn-outline-secondary">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4">
                <div class="ratio ratio-4x3">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d85152.37260823984!2d121.00677914861758!3d14.678761900000008!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3397b9ff787f76f5%3A0x85cc803d83902f16!2sAsian%20Institute%20of%20Computer%20Studies%20-%20Commonwealth!5e1!3m2!1sen!2sph!4v1747357476410!5m2!1sen!2sph"
                     style="border:0;"
                     allowfullscreen=""
                    loading="lazy"
                    referrerpolicy="no-referrer-when-downgrade"
                     title="AICS Location"></iframe>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="background-color: #20006b; border-radius: 15px;">
            ...
            <div class="modal-body text-white">
                <p class="mb-3">Do you have any feedback from this training center?<br>Let us know in the field below.</p>
                <textarea class="form-control" placeholder="Type a message..." rows="6" style="resize: none; border-radius: 10px;"></textarea>
            </div>
            <div class="modal-footer border-0 justify-content-center">
                <button type="button" class="btn" style="background-color: #33c9ff; color: white; font-weight: 600; border-radius: 8px; padding: 10px 30px;">
                    Send Feedback
                </button>
            </div>
        </div>
