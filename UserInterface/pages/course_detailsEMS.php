    ...
    <div class="container py-5">
        ...
        <div class="course-box text-white shadow-lg rounded-4 p-4 p-md-5">
            <div class="row g-4 align-items-center">
                <!-- Left Column -->
                <div class="col-md-6">
                    <h1 class="h4 fw-bold text-white">Event Management Services NC III</h1>
                    <p class="fw-semibold mb-1">Mindtech Training and Development Institute Inc.</p>
                    <p><strong>Duration:</strong> 2 months</p>
                    <p><strong>Slots Available:</strong> 18</p>
                    ...
                    <p>
                        This course provides essential training in event planning,
                        coordination, and management. Students will learn how to organize,
                        execute, and evaluate various events, ensuring a successful outcome.
                    </p>
                ...
                <!-- Right Column -->
                <div class="col-md-6">
                    <img src="../../Assets/COURSE_BG/ems.jpg" alt="Course Image" class="img-fluid course-image shadow">
                </div>
            </div>
        </div>
    </div>
