    ...
    <div class="container py-5">
        ...
        <div class="course-box text-white shadow-lg rounded-4 p-4 p-md-5">
            <div class="row g-4 align-items-center">
                <!-- Left Column -->
                <div class="col-md-6">
                    <h1 class="h4 fw-bold text-white">Java Programming NC III</h1>
                    <p class="fw-semibold mb-1">Aureate Training and Assessment Center, Inc.</p>
                    <p><strong>Duration:</strong> 3 months</p>
                    <p><strong>Slots Available:</strong> 12</p>
                    <p><strong>Location:</strong> 2075 MH Del Pilar St, Bgy 701, Zone 077 Malate, Manila</p>
                    <p><strong>Contact:</strong> 0992 485 6189 | Aureate@gmail.com</p>

                    <h5 class="mt-4 fw-bold">Course Description:</h5>
                    <p>
                        This course provides essential training in Java programming,
                        software development, and application design. Students will learn
                        how to create, test, and deploy Java applications effectively.
                    </p>
                ...
                <!-- Right Column -->
                <div class="col-md-6">
                    <img src="../../Assets/COURSE_BG/java.jpg" alt="Course Image" class="img-fluid course-image shadow">
                </div>
            </div>
        </div>
    </div>
