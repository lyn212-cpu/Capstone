    ...
    <div class="container py-5">
        ...
        <div class="course-box text-white shadow-lg rounded-4 p-4 p-md-5">
            <div class="row g-4 align-items-center">
                <!-- Left Column -->
                <div class="col-md-6">
                    <h1 class="h4 fw-bold text-white">Technical Drafting NC II</h1>
                    <p class="fw-semibold mb-1">Pasay City Man Power Training Center</p>
                    <p><strong>Duration:</strong> 1 month</p>
                    <p><strong>Slots Available:</strong> 6</p>
                    <p><strong>Location:</strong> Pasay City, Metro Manila</p>
                    <p><strong>Contact:</strong> 0915 436 1043 | PCMPT@gmail.com</p>

                    <h5 class="mt-4 fw-bold">Course Description:</h5>
                    <p>
                        The Technical Drafting NC II course teaches manual and digital drafting,
                        blueprint reading, CAD operation, dimensioning, scaling, and industry
                        standards for creating accurate technical drawings.
                    </p>
                ...
                <!-- Right Column -->
                <div class="col-md-6">
                    <img src="../../Assets/COURSE_BG/td.jpg" alt="Course Image" class="img-fluid course-image shadow">
                </div>
            </div>
        </div>
    </div>
