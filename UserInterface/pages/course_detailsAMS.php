    ...
    <div class="container py-5">
        ...
        <div class="course-box text-white shadow-lg rounded-4 p-4 p-md-5">
            <div class="row g-4 align-items-center">
                <!-- Left Column -->
                <div class="col-md-6">
                    <h1 class="h4 fw-bold text-white">Automotive Servicing NC II</h1>
                    <p class="fw-semibold mb-1">Mindtech Training and Development Institute Inc.</p>
                    <p><strong>Duration:</strong> 2 months</p>
                    <p><strong>Slots Available:</strong> 5</p>
                    <p><strong>Location:</strong> 155 Dr. Sixto Antonio Ave., Pasig City, 1609 Metro Manila</p>
                    <p><strong>Contact:</strong> 0992 375 6789 | MTDI@example.com</p>

                    <h5 class="mt-4 fw-bold">Course Description:</h5>
                    <p>
                        This course provides essential training in automotive systems,
                        diagnostics, and repair. Students will learn how to troubleshoot
                        and service various vehicle components effectively.
                    </p>
                ...
                <!-- Right Column -->
                <div class="col-md-6">
                    <img src="../../Assets/COURSE_BG/ams.jpg" alt="Course Image" class="img-fluid course-image shadow">
                </div>
            </div>
        </div>
    </div>
