...
<main class="container-fluid d-flex flex-column gap-3 p-2">
    ...
    <nav class="container-fluid d-flex justify-content-between align-items-center">
        ...
        <button data-bs-target="#newCenter_modal" data-bs-toggle="modal"  style="background-color: #190960" class="btn text-light">New Course</button>
    </nav>
    <!--     User list table-->
...
<div class="modal fade" id="newCenter_modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="form-floating mb-3">
        ...
        <label for="CenterName">Course Name</label>
      </div>

      <select class="form-select mb-3" aria-label="Default select example">
        <option selected>Slot Availability</option>
